...
image: "/writeups/doctor/logo.png"
...
![Contenido de 10.10.10.209:80](/writeups/doctor/1.png)

#### doctors.htb

![Contenido de doctors.htb](/writeups/doctor/2.png)

#### 10.10.10.209:8089

![Contenido de 10.10.10.209:8089](/writeups/doctor/3.png)
...
![Logued doctors.htb](/writeups/doctor/4.png)

![Create post doctors.htb](/writeups/doctor/5.png)
...
![Ruta /archive](/writeups/doctor/6.png)

La ruta `/archive` parece no contener nada, vamos a probar a crear un post:

![Nuevo post](/writeups/doctor/7.png)

![Ruta /archive con nuevo post](/writeups/doctor/8.png)
...
![Prueba de SSTI](/writeups/doctor/9.png)

![Prueba de SSTI](/writeups/doctor/10.png)
