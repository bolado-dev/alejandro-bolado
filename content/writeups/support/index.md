...
tags: [Easy, SMB Enum, DNSpy, Information Leakage, Abusing Remote Management Users group, SharpHound + BloodHound Enumeration, rbcd Attack]
category: HackTheBox
---
...
![Ejecución del programa](/writeups/support/1.png)

Una vez aquí, descargaremos la herramienta `dnSpy` para ver el código:

![dnSpy](/writeups/support/2.png)
...
![dnSpy Debug](/writeups/support/3.png)
